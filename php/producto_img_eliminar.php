    ...
    if($check_producto->rowCount()==1){
        ...
        echo '
            <div class="notification is-danger is-light">
                ...
                La imagen la marca que intenta eliminar no existe
            </div>
        ';
        exit();
    }
	...
	if(is_file($img_dir.$datos['producto_foto'])){
		...
		if(!unlink($img_dir.$datos['producto_foto'])){
			echo '
	            <div class="notification is-danger is-light">
	                <strong>¡Ocurrio un error inesperado!</strong><br>
	                Error al intentar eliminar la imagen  , por favor intente nuevamente
	            </div>
	        ';
	        exit();
		}
    ...
    if($actualizar_producto->execute($marcadores)){
        echo '
            <div class="notification is-info is-light">
                ...
                La imagen de la marca ha sido eliminada exitosamente, pulse Aceptar para recargar los cambios.
        ...
        echo '
            <div class="notification is-warning is-light">
                <strong>¡IMAGEN O FOTO ELIMINADA!</strong><br>
                Ocurrieron algunos inconvenientes, sin embargo la imagen de la marca ha sido eliminada, pulse Aceptar para recargar los cambios.
