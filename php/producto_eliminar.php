<?php
    ...
    if($check_producto->rowCount()==1){
    	...
    	if($eliminar_producto->rowCount()==1){
    		...
    		if(is_file(filename: "./img/producto/".$datos['producto_foto'])){
    			chmod(filename: "./img/producto/".$datos['producto_foto'], permissions: 0777);
				unlink(filename: "./img/producto/".$datos['producto_foto']);
    		}

	        echo '
	            <div class="notification is-info is-light">
	                <strong>¡MARCA ELIMINADO!</strong><br>
        ...
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
                La descripción que intenta eliminar no existe
            </div>
        ';
    }
    $check_producto=null;