<?php
	/*== Almacenando datos ==*/
    $usuario=limpiar_cadena(cadena: $_POST['login_usuario']);
    $clave=limpiar_cadena(cadena: $_POST['login_clave']);
    ...
    if(verificar_datos(filtro: "[a-zA-Z0-9]{4,20}",cadena: $usuario)){
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
    ...
    if(verificar_datos(filtro: "[a-zA-Z0-9$@.-]{7,100}",cadena: $clave)){
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
