<?php
    ...
    if($ubicacion!=""){
    	if(verificar_datos("[a-zA-Z1-9áéíóúÁÉÍÓÚñÑ ]{1,150}",$ubicacion)){
	        echo '
	            <div class="notification is-danger is-light">
	                <strong>¡Ocurrio un error inesperado!</strong><br>
	                La Bodega no coincide con el formato solicitado
	            </div>
	        ';
	        exit();
	    }
    ...
    if($actualizar_categoria->execute($marcadores)){
        echo '
            <div class="notification is-info is-light">
                <strong>¡MARCA ACTUALIZADO!</strong><br>
        ...
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
                No se puedo actualizar, por favor intente nuevamente
            </div>
        ';
    }
