<?php
    ...
    if($actualizar_producto->execute(params: $marcadores)){
        echo '
            <div class="notification is-info is-light">
                <strong>¡DESCRIPCIÓN!</strong><br>
                La descripción se actualizo con exito
            </div>
        ';
    }else{
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
                No se pudo actualizar la descripción, por favor intente nuevamente
            </div>
        ';
    }
