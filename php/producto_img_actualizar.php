<?php
	...
	/*== Almacenando datos ==*/
    $product_id=limpiar_cadena(cadena: $_POST['img_up_id']);
    ...
    if($check_producto->rowCount()==1){
        ...
        echo '
            <div class="notification is-danger is-light">
                ...
                La imagen  que intenta actualizar no existe
            </div>
        ';
        exit();
    }
    ...
    if($actualizar_producto->execute($marcadores)){
        echo '
            <div class="notification is-info is-light">
                ...
                La imagen de la marca ha sido actualizada exitosamente, pulse Aceptar para recargar los cambios.
